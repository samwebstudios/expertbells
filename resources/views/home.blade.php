...
<main>
                ...
                <div class="col-12">
                    <div class="MBox mt-5 pt-5 text-center">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <span class="h5 fw-normal">Startup Advice from</span>
                                <h1 class="mb-4">World Class Experts</h1>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                                <a href="experts.php" class="btn btn-thm btn-lg">Find an Expert <img src="{{asset('frontend/img/arrow.svg')}}" class="ms-3" width="30" height="30"></a>
                        ...
                        <div class="VideoBox wow zoomIn">
                            ...
                            <video poster="{{asset('frontend/img/video-img.svg')}}" id="PVideo" muted loop playsinline preload="metadata"><source src="{{asset('frontend/img/video/video.mp4')}}" type="video/mp4"></video>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="Heading h2">Find an Expert in easy steps</h2>
                </div>
            </div>
            <div class="row justify-content-center mt-5">
                <div class="col-12 col-md-6 order-md-last">
                    <ul class="SerMenu ms-md-5" id="top-menu">
                        <li class="active">
                            <a href="#step1">
                                <div class="w-100"><span class="TitleS">Find an Expert</span>
                                <span class="Scon">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</span></div>
                            </a>
                            <picture>
                                <source srcset="{{asset('frontend/img/step1.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/step1.svg')}}" alt="steps" width="380" height="480" class="d-md-none">
                            </picture>
                        </li>
                        <li>
                            <a href="#step2">
                                <div class="w-100"><span class="TitleS">Book a Video Call</span>
                                <span class="Scon">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</span></div>
                            </a>
                            <picture>
                                <source srcset="{{asset('frontend/img/step2.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/step2.svg')}}" alt="steps" width="380" height="480" class="d-md-none">
                            </picture>
                        </li>
                        <li>
                            <a href="#step3">
                                <div class="w-100"><span class="TitleS">Connect Directly</span>
                                <span class="Scon">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</span></div>
                            </a>
                            <picture>
                                <source srcset="{{asset('frontend/img/step3.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/step3.svg')}}" alt="steps" width="380" height="480" class="d-md-none">
                            </picture>
                        </li>
                    </ul>
                </div>
                <div class="col-12 col-md-6 d-none d-md-block">
                    <section id="step1" class="ConS">
                        <picture>
                            <source srcset="{{asset('frontend/img/step1.webp')}}" type="image/webp">
                            <img loading="lazy" src="{{asset('frontend/img/step1.svg')}}" alt="steps" width="380" height="480">
                        </picture>
                    </section>
                    <section id="step2" class="ConS">
                        <picture>
                            <source srcset="{{asset('frontend/img/step2.webp')}}" type="image/webp">
                            <img loading="lazy" src="{{asset('frontend/img/step2.svg')}}" alt="steps" width="380" height="480">
                        </picture>
                    </section>
                    <section id="step3" class="ConS">
                        <picture>
                            <source srcset="{{asset('frontend/img/step3.webp')}}" type="image/webp">
                            <img loading="lazy" src="{{asset('frontend/img/step3.svg')}}" alt="steps" width="380" height="480">
                        </picture>
                    </section>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center wow slideInDown">
                <div class="col-lg-9 col-md-10 text-center">
                    <h2 class="Heading h2">Choose Your Expert</h2>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="owl-carousel ExpertsC">
                        <div class="item">
                            <div class="card ExpBlock verify">
                                <a href="experts-intro.php" class="card-header">
                                    <picture>
                                        <source srcset="{{asset('frontend/img/exp-img1.webp')}}" type="image/webp">
                                        <img loading="lazy" src="{{asset('frontend/img/exp-img1.svg')}}" alt="Product" width="380" height="480">
                                    </picture>
                                    <div loading="lazy" style="background:url('{{asset('frontend/img/exp-img1.webp')}}')"></div>
                                </a>
                                <a href="experts-intro.php" class="card-body text-center">
                                    <h3>Expert Name</h3>
                                    <small class="text-black"><strong class="d-block">Tech Entrepreneur + Investor</strong> (Business advisor)</small>
                                </a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="card ExpBlock">
                                <a href="experts-intro.php" class="card-header">
                                    <picture>
                                        <source srcset="{{asset('frontend/img/exp-img2.webp')}}" type="image/webp">
                                        <img loading="lazy" src="{{asset('frontend/img/exp-img2.svg')}}" alt="Product" width="380" height="480">
                                    </picture>
                                    <div loading="lazy" style="background:url('{{asset('frontend/img/exp-img2.webp')}}')"></div>
                                </a>
                                <a href="experts-intro.php" class="card-body text-center">
                                    <h3>Expert Name</h3>
                                    <small class="text-black"><strong class="d-block">Tech Entrepreneur + Investor</strong> (Business advisor)</small>
                        ...
                        <div class="item">
                            <div class="card ExpBlock">
                                <a href="experts-intro.php" class="card-header">
                                    <picture>
                                        <source srcset="{{asset('frontend/img/exp-img3.webp')}}" type="image/webp">
                                        <img loading="lazy" src="{{asset('frontend/img/exp-img3.svg')}}" alt="Product" width="380" height="480">
                                    </picture>
                                    <div loading="lazy" style="background:url('{{asset('frontend/img/exp-img3.webp')}}')"></div>
                                </a>
                                <a href="experts-intro.php" class="card-body text-center">
                                    <h3>Expert Name</h3>
                                    <small class="text-black"><strong class="d-block">Tech Entrepreneur + Investor</strong> (Business advisor)</small>
                        ...
                        <div class="item">
                            <div class="card ExpBlock">
                                <a href="experts-intro.php" class="card-header">
                                    <picture>
                                        <source srcset="{{asset('frontend/img/exp-img4.webp')}}" type="image/webp">
                                        <img loading="lazy" src="{{asset('frontend/img/exp-img4.svg')}}" alt="Product" width="380" height="480">
                                    </picture>
                                    <div loading="lazy" style="background:url('{{asset('frontend/img/exp-img4.webp')}}')"></div>
                                </a>
                                <a href="experts-intro.php" class="card-body text-center">
                                    <h3>Expert Name</h3>
                                    <small class="text-black"><strong class="d-block">Tech Entrepreneur + Investor</strong> (Business advisor)</small>
                        ...
                        <div class="item">
                            <div class="card ExpBlock">
                                <a href="experts-intro.php" class="card-header">
                                    <picture>
                                        <source srcset="{{asset('frontend/img/exp-img5.webp')}}" type="image/webp">
                                        <img loading="lazy" src="{{asset('frontend/img/exp-img5.svg')}}" alt="Product" width="380" height="480">
                                    </picture>
                                    <div loading="lazy" style="background:url('{{asset('frontend/img/exp-img5.webp')}}')"></div>
                                </a>
                                <a href="experts-intro.php" class="card-body text-center">
                                    <h3>Expert Name</h3>
                                    <small class="text-black"><strong class="d-block">Tech Entrepreneur + Investor</strong> (Business advisor)</small>
                    ...
                    <div class="text-center"><a href="experts.php" class="btn btn-thm2">View More <i class="fal fa-arrow-right"></i></a></div>
                </div>
            </div>
        </div>
    </section>
    <section class="Sec6">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="Heading h2">Featured in</h2>
                </div>
                <div class="col-12">
                    <div class="owl-carousel">
                        <picture>
                            <source srcset="{{asset('frontend/img/fe-img1.webp')}}" type="image/webp">
                            <img loading="lazy" src="{{asset('frontend/img/fe-img1.svg')}}" alt="Product" width="220" height="90">
                        </picture>
                        <picture>
                            <source srcset="{{asset('frontend/img/fe-img2.webp')}}" type="image/webp">
                            <img loading="lazy" src="{{asset('frontend/img/fe-img2.svg')}}" alt="Product" width="220" height="90">
                        </picture>
                        <picture>
                            <source srcset="{{asset('frontend/img/fe-img3.webp')}}" type="image/webp">
                            <img loading="lazy" src="{{asset('frontend/img/fe-img3.svg')}}" alt="Product" width="220" height="90">
                        </picture>
                        <picture>
                            <source srcset="{{asset('frontend/img/fe-img4.webp')}}" type="image/webp">
                            <img loading="lazy" src="{{asset('frontend/img/fe-img4.svg')}}" alt="Product" width="220" height="90">
                        </picture>
                        <picture>
                            <source srcset="{{asset('frontend/img/fe-img5.webp')}}" type="image/webp">
                            <img loading="lazy" src="{{asset('frontend/img/fe-img5.svg')}}" alt="Product" width="220" height="90">
                        </picture>
                        <picture>
                            <source srcset="{{asset('frontend/img/fe-img6.webp')}}" type="image/webp">
                            <img loading="lazy" src="{{asset('frontend/img/fe-img6.svg')}}" alt="Product" width="220" height="90">
                        </picture>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center mb-5">
                    <h2 class="Heading h2">Find an Expert Category</h2>
                </div>
                <div class="col-lg-3 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <picture>
                                <source srcset="{{asset('frontend/img/exp-cat1.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/exp-cat1.svg')}}" alt="Business" width="90" height="90">
                            </picture>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <picture>
                                <source srcset="{{asset('frontend/img/exp-cat2.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/exp-cat2.svg')}}" alt="Sales & Marketing" width="90" height="90">
                            </picture>
                        </div>
                        <div class="card-body">
                            <h3 class="h4">Sales & Marketing</h3>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <picture>
                                <source srcset="{{asset('frontend/img/exp-cat3.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/exp-cat3.svg')}}" alt="Funding" width="90" height="90">
                            </picture>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <picture>
                                <source srcset="{{asset('frontend/img/exp-cat4.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/exp-cat4.svg')}}" alt="Product & Design" width="90" height="90">
                            </picture>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <picture>
                                <source srcset="{{asset('frontend/img/exp-cat5.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/exp-cat5.svg')}}" alt="Technology" width="90" height="90">
                            </picture>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <picture>
                                <source srcset="{{asset('frontend/img/exp-cat6.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/exp-cat6.svg')}}" alt="Skills & Management" width="90" height="90">
                            </picture>
                        </div>
                        <div class="card-body">
                            <h3 class="h4">Skills & Management</h3>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <picture>
                                <source srcset="{{asset('frontend/img/exp-cat7.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/exp-cat7.svg')}}" alt="Industries" width="90" height="90">
                            </picture>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card">
                        <div class="card-header">
                            <picture>
                                <source srcset="{{asset('frontend/img/exp-cat8.webp')}}" type="image/webp">
                                <img loading="lazy" src="{{asset('frontend/img/exp-cat8.svg')}}" alt="Other" width="90" height="90">
                            </picture>
                        </div>
                        <div class="card-body">
    ...
    <section class="Sec3">
        ...
        <div class="container">
            <div class="row justify-content-center wow slideInDown">
                <div class="col-lg-9 col-md-10 text-center">
                    <h2 class="Heading h2">Experts Video Gallery</h2>
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="owl-carousel VideoSec wow slideInUp">
                        <div class="item">
                            <div class="card">
                                <div class="card-header">
                                    <div class="youtube-player" data-id="rsUfwRwSj5s"></div>
                                    <!-- <a data-fancybox="" class="playVideo" href="https://www.youtube.com/watch?v=6m2EiDaKsUM" title="Video Gallery"></a> -->
                                    <a href="video-detail.php" class="playVideo"></a>
                                </div>
                                <a href="video-detail.php" class="card-body">
                                    <h3>Video Title</h3>
                                    <small class="text-secondary me-3"><i class="far fa-user thm"></i> Expert Name</small>
                                    <small class="text-secondary"><i class="far fa-tag thm"></i> Tech Entrepreneur + Investor </small>
                                </a>
                            </div>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            <div class="card">
                                <div class="card-header">
                                    <div class="youtube-player" data-id="2VzsIMB0jZw"></div>
                                    <!-- <a data-fancybox="" class="playVideo" href="https://www.youtube.com/watch?v=6m2EiDaKsUM" title="Video Gallery"></a> -->
                                    <a href="video-detail.php" class="playVideo"></a>
                                </div>
                                <a href="video-detail.php" class="card-body">
...
.SerMenu{position:sticky;top:66px;padding:0;/*max-width:500px*/}
.SerMenu li{counter-increment:slides-num;padding:25px;border-radius:20px;margin-bottom:9px}
.SerMenu li>a:before{content:" "counter(slides-num);height:40px;min-width:40px;font-size:26px;font-weight:600;margin-right:25px;background:var(--thm);border-radius:50%;color:var(--white);display:grid;place-content:center;line-height:24px}
.SerMenu li a{display:flex}
.SerMenu li img{height:auto;width:300px;display:flex;margin:20px auto 0;}
.SerMenu li .TitleS{font-size:26px;font-weight:800;display:flex;margin-top:7px;color:var(--thm);justify-content:space-between}
.SerMenu li .TitleS:after{content:'';border:none;border-bottom:2px solid;border-left:2px solid;height:9px;width:9px;transform:rotate(-45deg);display:block;transition:all .5s}
.SerMenu li .Scon{opacity:0;visibility:hidden;margin-top:12px;font-size:14px;line-height:140%!important;font-weight:300;display:none;transition:all .5s}
.SerMenu li.active{background:var(--thm)}
.SerMenu li.active .TitleS{color:var(--white)}
.SerMenu li.active>a:before{background:var(--white);color:var(--thm)}
.SerMenu li.active .TitleS:after{transform:rotate(135deg)}
.SerMenu li.active .Scon{opacity:1;visibility:visible;color:var(--white);display:block}
.TabSec section img{height:450px;max-width:500px;width:100%;object-fit:contain;padding:0}
.TabSec section>picture{position:relative;display:block}
.TabSec section>picture:after,.TabSec section>picture:before{position:absolute;top:-30px;right:25%;height:130px;width:130px;background:var(--thm3);opacity:.1;border-radius:50%;content:'';z-index:-1}
.TabSec section>picture:after{height:240px;width:240px;right:auto;left:0;top:auto;bottom:0;transform:translate(-40%, 30%);background:var(--thm);opacity:.1}
...
@media (min-width:992px){.TabSec section{min-height:90vh}}
...
.SerMenu li .TitleS{font-size:22px}
.SerMenu li>a:before{margin-right:15px;}
}
</style>
...
function initYouTubeVideos() {
  ...
  for (var n = 0; n < playerElements.length; n++) {
    ...
    thumbNode.src = '//i.ytimg.com/vi/ID/hqdefault.svg')}}'.replace(
      'ID',
      videoId
    );
