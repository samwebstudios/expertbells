                                ...
                                <div class="w-100">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-6 mt-3">
                                            <ul class="prolist AllDetail">
                                                <li class="d-block"><span>Your Role</span>
                                                    <div class="radiob">
                                                        <div class="form-check mb-2">
                                                            <input class="inputtext" type="radio" name="role" id="role1" autocomplete="off" contenteditable="false" readonly="readonly" disabled="disabled">
                                                            <label for="role1">{{$user->roles->title ?? ''}}</label>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-12 col-lg-6 mt-3">
                                            <ul class="prolist AllDetail">
                                                <li class="d-block"><span>Industry</span>
                                                    <div class="radiob">
                                                        <div class="form-check mb-2">
                                                            <input class="inputtext" type="checkbox" name="ind" id="ind1" autocomplete="off" contenteditable="false" readonly="readonly" disabled="disabled">
                                                            <label for="ind1">{{$user->industries->title ?? ''}}</label>
                                                        </div>                                                        
                                                    </div>
                                                </li>
                                            </ul>
                                            ...
                                            <ul class="prolist AllDetail">
                                                <li class="d-block"><span>Growth Challenge</span>
                                                    <div class="radiob">
                                                        <div class="form-check mb-2">
                                                            <input class="inputtext" type="checkbox" name="ind" id="ind1" autocomplete="off" contenteditable="false" readonly="readonly" disabled="disabled">
                                                            <label for="ind1">{{$user->growth_challenge ?? ''}}</label>
                                                        </div>                                                        
                                                    </div>
                                                </li>
                                            </ul>
...
.inputtext[readonly="readonly"],.inputtext[readonly=""],select.inputtext,.inputtext[contenteditable="false"]{border:none;width:100%;resize:none;overflow:hidden;padding:2px 0}
...
.radiob input[type="radio"]:disabled~label,.radiob input[type="checkbox"]:disabled~label{border:none!important;padding-left:0}
.radiob input[type="radio"]:checked~label,.radiob input[type="checkbox"]:checked~label{color:var(--white);padding-left:.6rem;z-index:1}
