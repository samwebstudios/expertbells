...
<div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
        <div class="col-md-6">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                @if($parent==0)
                <span class="breadcrumb-item active">FAQs Category</span>
                @else
                <a class="breadcrumb-item" href="{{route('admin.faqscategory')}}">FAQs Category</a>
                <span class="breadcrumb-item active">{{$parentdata->title ?? 'Child Category'}}</span>
                @endif                
            </nav>
        </div>
        <div class="col-md-6">
            <div class="text-right">
                <a href="{{route('admin.newfaqscategory',['id'=>$parent])}}" class="btn btn-dark btn-with-icon">
                    <div class="ht-40">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <form method="POST" action="{{route('admin.faqscategorysequence')}}" class="table-wrapper bannerform">
                @csrf
                <table class="table table-bordered table-colored table-dark">
                            ...
                            <th class="wd-5p">
                                <div class="dropdown TAction show">
                                    ...
                                    <ul class="dropdown-menu" x-placement="bottom-end">
                                        <li><a href="javascript:void(0)" onclick="$('.bannerform').attr('action','{{route('admin.faqscategorysequence')}}'); $('.bannerform').submit();"><i
                                                    class="fa fa-sitemap"></i> Update Sequence</a>
                                        </li>
                                        <li><a href="javascript:void(0)" onclick="$('.bannerform').attr('action','{{route('admin.bulkfaqscategorydestory')}}');  $('.bannerform').submit();"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($parent==0)
                            <td>
                                <a href="{{route('admin.faqscategory',['id'=>$list->id])}}" class="btn btn-dark">
                                    {{count($list->child)}}
                                </a>
                            </td>
                            @endif
                            ...
                            <td class="pd-r-0-force tx-center">
                                ...
                                <div class="dropdown TAction show">
                                    ...
                                    <ul class="dropdown-menu" x-placement="bottom-end">
                                        ...
                                        <li><a href="{{route('admin.editfaqscategory',['id'=>$list->id])}}" ><i class="fa fa-pencil"></i> Edit</a></li>

                                        <li><a href="{{route('admin.faqscategoryremove',['removeid'=>$list->id])}}" class="text-danger"
...
@endsection
@push('css')
<title>FAQs Category : {{project()}}</title>
@endpush
@push('js')
<script>
    function changestatus(id){
        ...
        let url = @json(route('admin.faqscategorypublish'));
