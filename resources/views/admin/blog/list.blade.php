...
<div class="br-mainpanel">
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        ...
        <div class="col-md-6">
            <div class="text-right">
                <a href="{{route('admin.newblog')}}" class="btn btn-dark btn-with-icon">
                    <div class="ht-40">
                        <span class="icon wd-40"><i class="fa fa-plus"></i></span>
                        <span class="pd-x-15">Add New</span>
                    </div>
                </a>
                <a href="{{route('admin.blogcms')}}" target="_blank" class="btn btn-dark btn-with-icon">
                    <div class="ht-40">
                        <span class="icon wd-40"><i class="fa fa-book"></i></span>
                        <span class="pd-x-15">Blog Page Content</span>
                    </div>
                </a>
                <a href="{{route('admin.blogcategory')}}" class="btn btn-dark btn-with-icon">
                    <div class="ht-40">
                        <span class="icon wd-40"><i class="fa fa-book"></i></span>
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <form method="POST" action="{{route('admin.blogsequence')}}" class="table-wrapper bannerform">
                @csrf
                <table class="table table-bordered table-colored table-dark">
                            ...
                            <th class="wd-5p">
                                <div class="dropdown TAction show">
                                    ...
                                    <ul class="dropdown-menu" x-placement="bottom-end">
                                        <li><a href="javascript:void(0)" onclick="$('.bannerform').attr('action','{{route('admin.blogsequence')}}'); $('.bannerform').submit();"><i
                                                    class="fa fa-sitemap"></i> Update Sequence</a>
                                        </li>
                                        <li><a href="javascript:void(0)" onclick="$('.bannerform').attr('action','{{route('admin.bulkblogdestory')}}');  $('.bannerform').submit();"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$list->title}}</td>
                            <td>{{dateformat($list->post_date)}}</td>
                            ...
                            <td class="pd-r-0-force tx-center">
                                ...
                                <div class="dropdown TAction show">
                                    ...
                                    <ul class="dropdown-menu" x-placement="bottom-end">
                                        ...
                                        <li><a href="{{route('admin.editblog',['id'=>$list->id])}}" ><i class="fa fa-pencil"></i> Edit</a></li>

                                        <li><a href="{{route('admin.blogremove',['removeid'=>$list->id])}}" class="text-danger"
...
<script>
    function changestatus(id){
        ...
        let url = @json(route('admin.blogpublish'));
