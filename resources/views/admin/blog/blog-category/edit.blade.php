  ...
  <div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
      <nav class="breadcrumb pd-0 mg-0 tx-12">
        ...
        <a class="breadcrumb-item" href="{{action('Admin\BlogCategoryController@index')}}">Blog Category</a>
      ...
      <div class="br-section-wrapper">
        ...
        <div class="form-layout form-layout-1">
          <div class="row mg-b-25">
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="category_name" value="{{old('category_name',$lists->title)}}" placeholder="Category Name Here...">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="alias" value="{{old('alias',$lists->alias)}}" placeholder="Category Alias Here...">
          ...
          <div class="form-layout-footer text-right">
            ...
            <a href="{{action('Admin\BlogCategoryController@index')}}" class="btn btn-dark">Cancel</a>
...
@push('style')
  ...
  <title>Update Category : {{project()}}</title>
@endpush
@push('scripts')
@endpush    
</x-admin-layout>