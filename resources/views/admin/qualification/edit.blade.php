<form method="post" class="updateform">
    ...
    <div class="form-layout-footer text-right">
        ...
        <a href="{{route('admin.qualifications')}}" class="btn btn-danger">Cancel</a>
...
<script>
    $('.updateform').on('submit',function(e){
        ...
        $.ajax({
            ...
            url:@json(route('admin.updatequalifications')),
            method:'POST',
            dataType:'Json',
            cache:false,
            contentType:false,
            ...
            success:function(data){
                loadingbox();
                $('.offcanvas-body').load(@json(route('admin.editqualification',['id'=>$lists->id])));
