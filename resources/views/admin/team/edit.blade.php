...
<div class="br-mainpanel">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <form method="POST" action="{{route('admin.updateteams')}}" enctype="multipart/form-data" class="table-wrapper sequenceform">
                @csrf
                ...
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg-12">            
                        <div class="form-group">            
                            ...
                            <input type="text" class="form-control" value="{{ old('designation',$data->designation) }}" name="designation"
                    ...
                    <div class="col-lg-6">            
                        <div class="form-group">            
                            ...
                            <input type="url" class="form-control" value="{{ old('facebook',$data->facebook) }}" name="facebook"
                    ...
                    <div class="col-lg-6">            
                        <div class="form-group">            
                            ...
                            <input type="url" class="form-control" value="{{ old('linkedin',$data->linkedin) }}" name="linkedin"
                    ...
                    <div class="col-lg-6">            
                        <div class="form-group">            
                            ...
                            <input type="url" class="form-control" value="{{ old('twitter',$data->twitter) }}" name="twitter"
                    ...
                    <div class="col-lg-6">            
                        <div class="form-group">            
                            ...
                            <input type="url" class="form-control" value="{{ old('instagram',$data->instagram) }}" name="instagram"
                    ...
                    <div class="col-lg-6">            
                        <div class="form-group">            
                            ...
                            <input type="url" class="form-control" value="{{ old('pinterest',$data->pinterest) }}" name="pinterest"
