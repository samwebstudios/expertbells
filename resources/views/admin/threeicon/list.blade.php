        ...
        <div class="br-pageheader pd-y-15 pd-l-20">
            ...
            <div class="col-md-6">
                ...
                <nav class="breadcrumb pd-0 mg-0 tx-12">
                    ...
                    <span class="breadcrumb-item active">Three Icons</span>
                ...
                <div class="col-sm-5">
                    ...
                    <div class="card shadow-base bd-0">
                        ...
                        <div class="card-body justify-content-between align-items-center">
                            ...
                            <form method="post" action="{{ route('admin.savethreeicons') }}"
...
@push('js')
    ...
    <script>
        ...
        $('.sequenceform').on('click', function() {
            $('.table-wrapper').attr('action', @json(route('admin.threeiconsequence')));
            $('.table-wrapper').submit();
        });
        $('.bulkremoveform').on('click', function() {
            $('.table-wrapper').attr('action', @json(route('admin.bulkremovethreeicon')));
            $('.table-wrapper').submit();
        });
        ...
        function changestatus(id) {
            ...
            let url = @json(route('admin.changethreeiconstatus'));
            databasestatuschange(url, status, id);
        }
        $('[data-bs-id]').on('click', function() {
            let id = $(this).attr('data-bs-id');
            $('.offcanvas-title').text('Edit Icon');
            loadingbox();
            $('.offcanvas-body').load(@json(route('admin.editthreeicon')) + '?id=' + id);
        });
        imgInp.onchange = evt => {
...
@endpush
@push('css')
    <title>Three Icons Management : {{ project() }}</title>
