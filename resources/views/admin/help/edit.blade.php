...
<div class="br-mainpanel">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <form method="POST" action="{{route('admin.helpcenter.update')}}" enctype="multipart/form-data" class="table-wrapper sequenceform">
                @csrf
                ...
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg-3">            
                        <div class="form-group">            
                            ...
                            <select class="form-control" name="help_for">
                                ...
                                <option value="1" @selected(old('help_for',$lists->type)==1)>Experts</option>
                                <option value="2" @selected(old('help_for',$lists->type)==2) >Users</option>
                            </select>    
                    ...
                    <div class="col-lg-12">            
                        <div class="form-group">            
                            ...
                            <textarea class="form-control" id="summernote" name="description" placeholder="Write somthing here...">{{ old('description',$lists->description) }}</textarea>
