                                            ...
                                            <th class="wd-5p">
                                                <div class="dropdown TAction show">
                                                    ...
                                                    <ul class="dropdown-menu" x-placement="bottom-end">
                                                        ...
                                                        <li onclick="$('.listform').attr('action','{{route('admin.helpcenter.sequence')}}'); $('.listform').submit();"><a href="javascript:void(0)"><i
                                                                    class="fa fa-sitemap"></i> Update Sequence</a>
                                                        </li>

                                                        <li onclick="$('.listform').attr('action','{{route('admin.helpcenter.bulkremove')}}'); $('.listform').submit();"><a href="javascript:void(0)"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($lists as $list)
                                            <tr>
                                                ...
                                                <td>
                                                   @if($list->type==1) <span class="badge badge-dark">Experts</span> @endif
                                                   @if($list->type==2) <span class="badge badge-primary">Users</span> @endif
                                                </td>                                                
                                                <td>{{ $list->title }}</td>
                                                ...
                                                <td class="pd-r-0-force tx-center">
                                                    ...
                                                    <div class="dropdown TAction show">
                                                        ...
                                                        <ul class="dropdown-menu" x-placement="bottom-end">
                                                            ...
                                                            <li><a href="{{ route('admin.helpcenter.edit', ['id' => $list->id]) }}"><i
                                                                        class="fa fa-pencil"></i> Edit</a></li>

                                                            <li><a href="{{ route('admin.helpcenter.remove', ['id' => $list->id]) }}"
                                                                    class="text-danger"
...
@push('js')
    <script>
        ...
        function changestatus(id){
            ...
            let url = @json(route('admin.helpcenter.status'));
