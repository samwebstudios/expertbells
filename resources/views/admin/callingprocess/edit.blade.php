<form method="post" class="updateform">
    ...
    <div class="row mg-b-25">
        ...
        <div class="col-lg-12">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" placeholder="Write something here...">{{ old('description', $lists->description) }}</textarea>
    ...
    <div class="form-layout-footer text-right">
        ...
        <a href="{{route('admin.callingprocess')}}" class="btn btn-danger">Cancel</a>
...
<script>
    $('.updateform').on('submit',function(e){
        ...
        $.ajax({
            ...
            url:@json(route('admin.updatecallingprocess')),
            method:'POST',
            dataType:'Json',
            cache:false,
            contentType:false,
            ...
            success:function(data){
                loadingbox();
                $('.offcanvas-body').load(@json(route('admin.editcallingprocess',['id'=>$lists->id])));
