...
<div class="br-mainpanel">
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        ...
        <div class="col-md-6">
            ...
            <span class="breadcrumb-item active">Career Management</span>
        ...
        <div class="col-md-6">
            <div class="text-right">
                <a href="{{route('admin.addcareer')}}" class="btn btn-dark btn-with-icon">
                    <div class="ht-40">
                            ...
                            <th class="wd-5p">
                                <div class="dropdown TAction show">
                                    ...
                                    <ul class="dropdown-menu" x-placement="bottom-end">
                                        <li><a href="javascript:void(0)" onclick="$('.bannerform').attr('action','{{route('admin.careersequence')}}'); $('.bannerform').submit();"><i
                                                    class="fa fa-sitemap"></i> Update Sequence</a>
                                        </li>
                                        <li><a href="javascript:void(0)" onclick="$('.bannerform').attr('action','{{route('admin.bulkcareerdestory')}}');  $('.bannerform').submit();"
                        ...
                        <td class="pd-r-0-force tx-center">
                            ...
                            <div class="dropdown TAction show">
                                ...
                                <ul class="dropdown-menu" x-placement="bottom-end">
                                    ...
                                    <li><a href="{{route('admin.editcareer',['id'=>$list->id])}}" ><i class="fa fa-pencil"></i> Edit</a></li>

                                    <li><a href="{{route('admin.removecareer',['removeid'=>$list->id])}}" class="text-danger"
...
@endsection
@push('css')
<title>Career Management : {{project()}}</title>
@endpush
@push('js')
<script>
    function changestatus(id){
        ...
        let url = @json(route('admin.careerpublish'));
