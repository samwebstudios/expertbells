...
<div class="br-mainpanel">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <form method="POST" action="{{route('admin.savecareer')}}" enctype="multipart/form-data" class="table-wrapper sequenceform">
                @csrf
                <div class="row mg-b-25">
                    ...
                    <div class="col-lg-6">            
                        <div class="form-group">            
                            ...
                            <input type="text" class="form-control" value="{{ old('role') }}" name="role"
                    ...
                    <div class="col-lg-12">            
                        <div class="form-group">            
                            ...
                            <input type="text" class="form-control" value="{{ old('locations') }}" name="locations"
...
@endsection
@push('css')
<title>Add Career : {{project()}}</title>
@endpush
@push('js')
