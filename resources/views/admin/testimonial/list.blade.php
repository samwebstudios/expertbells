...
<div class="br-mainpanel">
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        ...
        <div class="col-md-6">
            <div class="text-right">
                <a href="{{route('admin.addtestimonial')}}" class="btn btn-dark btn-with-icon">
                    <div class="ht-40">
                        <span class="icon wd-40"><i class="fa fa-plus"></i></span>
                        <span class="pd-x-15">Add New</span>
                    </div>
                </a>
                <a href="{{route('admin.testimonialcms')}}" class="btn btn-dark btn-with-icon">
                  <div class="ht-40">
                      <span class="icon wd-40"><i class="fa fa-plus"></i></span>
                      <span class="pd-x-15">Testimonial Cms</span>
                  </div>
              </a>                
            </div>
        </div>
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <form method="POST" action="{{route('admin.testimonialsequence')}}" class="table-wrapper bannerform">
                @csrf
                            ...
                            <th class="wd-5p">
                                <div class="dropdown TAction show">
                                    ...
                                    <ul class="dropdown-menu" x-placement="bottom-end">
                                        <li><a href="javascript:void(0)" onclick="$('.bannerform').attr('action','{{route('admin.testimonialsequence')}}'); $('.bannerform').submit();"><i
                                                    class="fa fa-sitemap"></i> Update Sequence</a>
                                        </li>
                                        <li><a href="javascript:void(0)" onclick="$('.bannerform').attr('action','{{route('admin.bulkdestorytestimonial')}}');  $('.bannerform').submit();"
                        ...
                        <td class="pd-r-0-force tx-center">
                            ...
                            <div class="dropdown TAction show">
                                ...
                                <ul class="dropdown-menu" x-placement="bottom-end">
                                    ...
                                    <li><a href="{{route('admin.edittestimonial',['id'=>$list->id])}}" ><i class="fa fa-pencil"></i> Edit</a></li>
...
@endsection
@push('css')
<title>Testimonials Management : {{project()}}</title>
@endpush
@push('js')
<script>
    function changestatus(id){
        ...
        let url = @json(route('admin.testimonialpublish'));
