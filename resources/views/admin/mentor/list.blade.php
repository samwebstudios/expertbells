        ...
        <div class="br-pageheader pd-y-15 pd-l-20">
            ...
            <div class="col-md-6">
                ...
                <nav class="breadcrumb pd-0 mg-0 tx-12">
                    ...
                    <span class="breadcrumb-item active">Mentor</span>
            ...
            <div class="col-md-6">
                ...
                <div class="text-right">
                    <a href="{{route('admin.memtorcms')}}" class="btn btn-dark">
                        Mentor Cms
                    </a>
                </div>
                ...
                <div class="col-sm-5">
                    ...
                    <div class="card shadow-base bd-0">
                        ...
                        <div class="card-body justify-content-between align-items-center">
                            ...
                            <form method="post" action="{{ route('admin.savementor') }}"
                                                    ...
                                                    <td class="pd-r-0-force tx-center">
                                                        ...
                                                        <div class="dropdown TAction show">
                                                            ...
                                                            <ul class="dropdown-menu" x-placement="bottom-end">
                                                                ...
                                                                <li><a href="{{ route('admin.removementor', ['id' => $list->id]) }}"
                                                                        class="text-danger"
...
@push('js')
    ...
    <script>
        ...
        $('.sequenceform').on('click', function() {
            $('.table-wrapper').attr('action', @json(route('admin.mentorsequence')));
            $('.table-wrapper').submit();
        });
        $('.bulkremoveform').on('click', function() {
            $('.table-wrapper').attr('action', @json(route('admin.bulkremovementor')));
            $('.table-wrapper').submit();
        });
        ...
        function changestatus(id) {
            ...
            let url = @json(route('admin.changementorstatus'));
            databasestatuschange(url, status, id);
        }
        $('[data-bs-id]').on('click', function() {
            let id = $(this).attr('data-bs-id');
            $('.offcanvas-title').text('Edit Mentor');
            loadingbox();
            $('.offcanvas-body').load(@json(route('admin.editmentor')) + '?id=' + id);
        });
        imgInp.onchange = evt => {
